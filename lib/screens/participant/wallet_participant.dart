  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: RefreshIndicator(
        onRefresh: () async { infosFinanceParticipant(); },
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text("${infos_wallet_participant?.solde_participant ?? 0} FCFA",style: TextStyle(
                                      fontSize: 40.sp,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white
                                  ),)
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text("${infos_wallet_participant?.transaction_journaliere.toStringAsFixed(0) ?? 0} / ${infos_wallet_participant?.limite_kyc_jour.toStringAsFixed(0) ?? 0}",style: TextStyle(
                            fontSize: 20.sp,
                      ...
                      LinearProgressIndicator(
                        value: () {
                          ...
                          double transac = (infos_wallet_participant?.transaction_journaliere ?? 0).toDouble();
                          double limite = (infos_wallet_participant?.limite_kyc_jour ?? 0).toDouble();

                          // ✅ Éviter division par zéro
                          if (limite == 0) return 0.0;

                          // ✅ Calculer progression
                          double progression = transac / limite;

                          // ✅ Limiter entre 0 et 1 (éviter Infinity/NaN)
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text("${infos_wallet_participant?.transaction_mois.toStringAsFixed(0) ??0} / ${infos_wallet_participant?.limite_kyc_mois.toStringAsFixed(0) ?? 0}",style: TextStyle(
                            fontSize: 20.sp,
                            fontWeight: FontWeight.w500,
                          ),)
                        ],
                      ...
                      LinearProgressIndicator(
                        value:() {
                          // ✅ Récupérer les valeurs
                          double transac = (infos_wallet_participant?.transaction_mois ?? 0).toDouble();
                          double limite = (infos_wallet_participant?.limite_kyc_mois ?? 0).toDouble();
